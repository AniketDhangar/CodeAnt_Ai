        ...
        <div className="flex flex-col w-full md:w-64 bg-white md:h-screen border-r relative">
            <div className={`flex justify-between md:justify-around w-full px-4 items-center`}>
                <div className="flex items-center justify-center gap-4 h-16">
                    ...
                    <h1 className="text-lg font-bold">CodeAnt AI</h1>
                </div>
            ...
            >
                ...
                <span className="mt-2 text-md border p-2 rounded-xl flex gap-2 items-center">
                    <span>Aniket Dhangar</span>
                    <ChevronDownIcon className={`w-5`}/>
                </span>
                    </div>

                    <nav id="menu" className="flex-1 px-4 py-2 space-y-2">
                        <a
                            href="#"
                            className="flex items-center px-4 py-2 text-sm font-md font-bold bg-[#1570EF] text-white rounded-lg"
                        >
