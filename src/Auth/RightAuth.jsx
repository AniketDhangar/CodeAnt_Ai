...
const RightAuth = () => {
    ...
    return (
        <div className={`flex text-xl w-full max-w-[400px] md:max-w-full md:w-1/2 flex-col justify-center items-center p-4 gap-4`}>
            <div className={`bg-white flex flex-col rounded-xl w-full border`}>
                <div className={`border-b flex flex-col p-5 w-full gap-4`}>
                    ...
                    <div>
                        <div className={`bg-gray-100/70 border text-xl rounded-xl`}>
